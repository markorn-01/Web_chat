...
```
cd existing_repo
git remote add origin https://gitlab.com/galvdat/vgu_tinyprojects/pe2022/pe2022_team-6.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/galvdat/vgu_tinyprojects/pe2022/pe2022_team-6/-/settings/integrations)
